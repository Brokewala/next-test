...
// import type { NavItemType } from '@/src/components/NavItem';
...
export const headerSection = {
  title: 'NOUVELS ARRIVAGES!',
  heading: 'LA QUALITE EST NOTRE PRIORITE',
  description: "Nous avons une large gamme de produits de haute qualité, allant des vêtements aux accessoires. Nous nous engageons à vous offrir le meilleur service possible et à vous aider à trouver ce que vous cherchez.",
};

export const promotionTag = {
  heading: 'DISC UP TO 50% FOR SNEAKERS FEST ID 2025',
  description:
...
export const footerBannerData = {
  heading: 'Restez à la pointe avec des chaussures fantastiques',
  description:
    'Nous avons une large gamme de produits de haute qualité, allant des vêtements aux accessoires. Nous nous engageons à vous offrir le meilleur service possible et à vous aider à trouver ce que vous cherchez.',
};

export const footerData = {
  description:
    'Comores Local Market est une plateforme e-commerce dédiée à la promotion et à la vente de produits locaux des Comores. Notre mission est de soutenir les artisans et producteurs locaux tout en offrant au monde entier un accès à la richesse culturelle et gastronomique des îles Comoriennes.',
  footerLinks: [
    {
      title: 'Pages Principales',
      links: [
        { href: '/', name: 'Accueil' },
        { href: '/nos-produits', name: 'Produits' },
        { href: '/panier', name: 'Panier' },
        { href: '/commande', name: 'Commande' },
      ],
    },
    {
...
export const icons = [
  { name: "Vêtements", icon: "/icons/shirt.svg" },
  { name: "Chaussures", icon: "/icons/shoe.svg" },
  // { name: "Accessoires", icon: "/icons/accessories.svg" },
  { name: "Beauté & Soins", icon: "/icons/perfume.svg" },
  { name: "Électronique", icon: "/icons/charging-pile.svg" },
  { name: "Maison & Déco", icon: "/icons/sofa.svg" },
  { name: "Cuisine & Électro", icon: "/icons/tools-kitchen-3.svg" },
  { name: "Sport & Fitness", icon: "/icons/bike.svg" },
  { name: "Jouets & Jeux", icon: "/icons/horse-toy.svg" },
  // { name: "Bébés & Enfants", icon: "/icons/baby.svg" },
  // { name: "Animaux", icon: "/icons/pets.svg" },
  { name: "Livres & Culture", icon: "/icons/books.svg" },
  { name: "Auto & Moto", icon: "/icons/engine.svg" },
  { name: "Alimentation", icon: "/icons/burger.svg" }
]
